...
if(isset($_POST['mailform'])) {
   if(!empty($_POST['Nom']) AND !empty($_POST['Email']) AND !empty($_POST['message'])) {
      ...
      $header.='From:"nom_dexpediteur"<votre@mail.com>'."\n";
      ...
      <html>
         <body>
            <div align="center">
               ...
               <br />
               <u>Nom de lexpéditeur :</u>'.$_POST['Nom'].'<br />
               <u>Mail de lexpéditeur :</u>'.$_POST['Email'].'<br />
               <br />
               '.nl2br($_POST['message']).'
               <br />
                  ...
                  <form class="contact-form" action="#">
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col">
                              <input class="form-control lg-round" type="email" name="Email" placeholder="Votre email" value="<?php if(isset($_POST['Email'])) { echo $_POST['Email']; } ?>" /><br />
                           </div>
