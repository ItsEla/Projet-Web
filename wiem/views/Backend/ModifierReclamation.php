      ...
      <!-- Main Content -->
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Modification d'une Reclamation</h6>
          </div>
          <div class="card-body">
            
            <form action="ModifReclamation.php" method="POST" enctype="multipart/form-data" onsubmit="return validate_formcat()">
