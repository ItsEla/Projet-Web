      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="AfficherFacture.php">Liste Des Factures</a>

            <a class="collapse-item" href="listeCategories.php">Liste Des Fournisseurs</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Modification d'une Facture</h6>
          </div>
          <div class="card-body">
            
            <form action="ModifFacture.php" method="POST" onsubmit="return validate_formcat()">
                <div class="form-inline">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="ID" id="ID" placeholder="ID Facture">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="Montant" id="Montant" placeholder="Montant Facture">
                  </div>
